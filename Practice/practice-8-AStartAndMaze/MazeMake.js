function MazeMake(MazeYSize, MazeXSize) {
  ...
  this.WhereWall = function() {
    let Ay_WallPool = [];
    let idx = this.Ay_Maze.indexOf(53);
    while (idx != -1) {
      Ay_WallPool.push(idx);
      idx = this.Ay_Maze.indexOf(53, idx + 1);
    }
    idx = this.Ay_Maze.indexOf(0);
    while (idx != -1) {
      Ay_WallPool.push(idx);
      idx = this.Ay_Maze.indexOf(0, idx + 1);
    }
    idx = this.Ay_Maze.indexOf(50);
    while (idx != -1) {
      Ay_WallPool.push(idx);
      idx = this.Ay_Maze.indexOf(50, idx + 1);
    }
